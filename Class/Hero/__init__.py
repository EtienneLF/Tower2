...
class Hero(Class.Perso.Perso):
    ...
    def ismarchand(self, p_marchand, px, py):
        if self.aX + 35 > p_marchand.aX - px and self.aX < p_marchand.aX + p_marchand.aImage.get_width() - px and self.aY + 33 > p_marchand.aY - py and self.aY < p_marchand.aY + p_marchand.aImage.get_height() - py :
